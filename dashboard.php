...
<div class="topnav">
  ...
  <a href="login.php" style="float:right">DAFTAR/LOGIN</a>
</div>
  ...
  <div class="leftcolumn">
    <div class="card">
     <div class="alert info">
           <h3>Hai Ingin Membaca Komik/Manga Lebih banyak lagi ? silakan daftar/login </br>
      Nikmati baca komik/Manga sepuasnya khusus member yang sudah daftar :) </h3>
     </div>
    </div></div>
